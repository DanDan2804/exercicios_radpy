...
class GerenciadorAlunos:
    ...
    Attributes:
        ...
        txt_path (Path): Caminho do aqruivo TXT.
    ...
    def __init__(self, base_dir: Path):
        ...
        self.alunos: Dict[str, float] = self.carregar()
    ...
    def _carregar(self) -> Dict[str, float]:
        ...
        if self.csv_path.exists():
            try:
                ...
                print(f"Erro de sistema ao acessar o aqruivo: {oe}")
        return {}

    def salvar(self) -> None:
        """
        Salva os dados dos alunos no formato CSV, TXT e JSON.
        """
        try:
    ...
    def cadastrar(self, aluno: Aluno) -> bool:
        ...
        Returns:
            bool: True se o cadastro for bem sucedido.
        """
    ...
    def remover(self, nome: str) -> bool:
        ...
        Returns:
            bool: True se o aluno for removido, False caso contrário.
        """
...
if __name__ == "__main__":
    ...
    print("Cadastrando:", gerenciador.cadastrar(Aluno("Dan", 8.0)))
    print("Lendo:", gerenciador.buscar("Dan"))
    print("Lista completa:", gerenciador.listar())
    print("Removendo:", gerenciador.remover("Dan"))
    print("Lista após remoção:", gerenciador.listar())
    print("Novo cadastro:", gerenciador.cadastrar("Dan", 7.0))
    print("Alterando nota:", gerenciador.alterar_nota("Dan", 10.0))
